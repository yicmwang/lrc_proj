classdef  CasadiMeta < SwigRef
  ...
  methods(Static)
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(1024, varargin{:});
    end
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(1025, varargin{:});
    end
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(1027, varargin{:});
    end
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(1028, varargin{:});
    end
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(1029, varargin{:});
    end
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(1030, varargin{:});
    end
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(1031, varargin{:});
    end
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(1033, varargin{:});
    end
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(1034, varargin{:});
    end
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(1035, varargin{:});
    end
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(1036, varargin{:});
    end
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(1037, varargin{:});
    end
  end
end
