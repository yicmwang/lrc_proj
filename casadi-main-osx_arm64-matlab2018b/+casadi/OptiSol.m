classdef  OptiSol < casadi.PrintableCommon
  ...
  methods
    ...
    %
    %
      [varargout{1:nargout}] = casadiMEX(1434, self, varargin{:});
    end
    ...
    %
    %
      [varargout{1:nargout}] = casadiMEX(1435, self, varargin{:});
    end
    ...
    %
    %
      [varargout{1:nargout}] = casadiMEX(1436, self, varargin{:});
    end
    ...
    %
    %
      [varargout{1:nargout}] = casadiMEX(1437, self, varargin{:});
    end
    ...
    %
    %
      [varargout{1:nargout}] = casadiMEX(1438, self, varargin{:});
    end
    ...
    %
    %
      [varargout{1:nargout}] = casadiMEX(1439, self, varargin{:});
    end
    ...
    %
    %
      [varargout{1:nargout}] = casadiMEX(1440, self, varargin{:});
    end
    ...
    %
    %
      [varargout{1:nargout}] = casadiMEX(1441, self, varargin{:});
    end
