classdef  OptiAdvanced < casadi.Opti
  ...
  methods
    ...
    %
    %
      [varargout{1:nargout}] = casadiMEX(1397, self, varargin{:});
    end
    ...
    %
    %
      [varargout{1:nargout}] = casadiMEX(1400, self, varargin{:});
    end
    ...
    %
    %
      [varargout{1:nargout}] = casadiMEX(1403, self, varargin{:});
    end
    ...
    %
    %
      [varargout{1:nargout}] = casadiMEX(1409, self, varargin{:});
    end
    ...
    %
    %
      [varargout{1:nargout}] = casadiMEX(1418, self, varargin{:});
    end
    ...
    %
    %
      [varargout{1:nargout}] = casadiMEX(1419, self, varargin{:});
    end
    ...
    %
    %
      [varargout{1:nargout}] = casadiMEX(1420, self, varargin{:});
    end
    function v = problem_dirty_(self)
      v = casadiMEX(1421, self);
    end
    ...
    %
    %
      [varargout{1:nargout}] = casadiMEX(1425, self, varargin{:});
    end
    ...
    %
    %
      [varargout{1:nargout}] = casadiMEX(1426, self, varargin{:});
    end
    function v = solved_(self)
      v = casadiMEX(1427, self);
    end
    ...
    %
    %
      [varargout{1:nargout}] = casadiMEX(1428, self, varargin{:});
    end
    ...
    %
    %
      [varargout{1:nargout}] = casadiMEX(1429, self, varargin{:});
    end
    ...
    %
    %
      [varargout{1:nargout}] = casadiMEX(1430, self, varargin{:});
    end
    ...
    %
    %
      [varargout{1:nargout}] = casadiMEX(1431, self, varargin{:});
    end
    ...
    %
    %
      [varargout{1:nargout}] = casadiMEX(1432, self, varargin{:});
    end
