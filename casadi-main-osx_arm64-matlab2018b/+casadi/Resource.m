classdef  Resource < casadi.SharedObject & casadi.PrintableCommon
  ...
  methods
    ...
    %
    %
      [varargout{1:nargout}] = casadiMEX(1446, self, varargin{:});
    end
    ...
    %
    %
      [varargout{1:nargout}] = casadiMEX(1447, self, varargin{:});
    end
    ...
    %
    %
      [varargout{1:nargout}] = casadiMEX(1448, self, varargin{:});
    end
  ...
  methods(Static)
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(1444, varargin{:});
    end
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(1445, varargin{:});
    end
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(1449, varargin{:});
    end
  end
end
