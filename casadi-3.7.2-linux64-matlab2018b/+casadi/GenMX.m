classdef  GenMX < casadi.GenericMatrixCommon & casadi.SparsityInterfaceCommon
  ...
  methods
    ...
    %
    %
      out = casadiMEX(356, self, varargin{:});
      if nargout<=1
        varargout{1}=out;
      else
    ...
    %
    %
      [varargout{1:nargout}] = casadiMEX(367, self, varargin{:});
    end
    ...
    %
    %
      [varargout{1:nargout}] = casadiMEX(368, self, varargin{:});
    end
